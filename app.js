...
function testSum(a, b) {
  if (sum(a, b)[1] === `The sum of ${a} and ${b} is 11.`) {
...
function testMultiply(a, b) {
  if (multiply(a, b)[1] === `The product of ${a} and ${b} is 45.`) {
...
function testSumAndMultiply(a, b, c) {
  if (
    sumAndMultiply(a, b, c)[2] === `${a} and ${b} and ${c} sum to 16.` &&
    sumAndMultiply(a, b, c)[3] ===
      `The product of ${a} and ${b} and ${c} is 140.`
  ) {
...
function testMultiplyArray(array) {
  if (multiplyArray(array)[1] === "The numbers 2,3,4 have a product of 24.") {
